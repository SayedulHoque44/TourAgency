    ...
    try {
      ...
      await Promise.resolve().then(async () => {
        const location = await LocationModel.findById(id)
          .populate('resorts restaurants') // populate mane hocce location er bitore resort er bitoer id  jehula ache ogular full sob details resort theke ekhane niye asa / execute kora
          .exec();
